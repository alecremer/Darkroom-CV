...
class AnnotationEngine:
    ...
    def reset_annotation_cell(self, annotations: List[AnnotationCell], file_index: int):
        annotations[file_index].classes_boxes = [[]]
        annotations[file_index].classes_masks = [[]]
        annotations[file_index].excluded_classes_boxes = []
        annotations[file_index].excluded_classes_masks = []